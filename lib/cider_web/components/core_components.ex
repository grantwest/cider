defmodule CiderWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CiderWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CiderWeb.Gettext, "errors", msg, opts)
    end
  end
